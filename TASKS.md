...
- [x] Add ability to have mouse hover interactions like if you wiggle the mouse over the pet it will giggle and maybe run away etc.
- [x] Add ability to have llm api endpoints so that users can use other providers if needed like openrouter, openai, claude, etc.
